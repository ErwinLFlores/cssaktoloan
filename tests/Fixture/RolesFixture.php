...
class RolesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'others' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'others' => 1,
                'created' => '2021-11-01 11:15:51',
                'modified' => '2021-11-01 11:15:51',
            ],
        ];
        parent::init();
    }
