...
class EventTypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'color' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2022-02-04 15:03:28',
                'modified' => '2022-02-04 15:03:28',
            ],
        ];
        parent::init();
    }
