...
class CreateTableConstituents extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function change()
    {
        ...
        $table->addColumn('resident_key', 'integer', [
            'null' => true,
            'comment' => 'residents id when moved'
        ]);
