            ...
            <div class="card">
                ...
                <div class="col-md-12 card-footer">
                    <div class="col-md-6" style="text-align:left;">
                        <?= $this->Form->create('Add Category', ['type' => 'post', 'url' => '/manage/rejectloan/' . $data->id . '/contract']); ?>
                            <input type="submit" id="submitbutton" class="btn btn-danger" value="Reject Loan">
                        <?= $this->Form->end(); ?>
                    </div>
                    <div class="col-md-6" style="text-align:right;">
                        <?= $this->Form->create('Add Category', ['type' => 'post', 'url' => '/manage/verifycontract/' . $data->id . '/contract']); ?>
                            <input type="submit" id="submitbutton" class="btn btn-info" value="Agree and Confirm">
                            <textarea name="contract" id="contract" cols="30" rows="10" style="display: none;"><?php echo($contract); ?></textarea>
                        <?= $this->Form->end(); ?>
                    </div>
                </div>
            </div>
