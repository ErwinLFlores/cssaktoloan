            ...
            <div class="card">
                <div class="card-header">
                    <div class="col-sm-6 no-padding">
                        ...
                        <?php 
                            if (
                                (isset($logged_roles['Residents']['action_members']))
                                && ($logged_roles['Residents']['action_members'] === 1)
                                && (isset($member_search))
                                && ($member_search == 1)
                                ...
                                <?= $this->Form->create('Add Search Item', ['type' => 'get', 'url' => ['controller' => 'Residents', 'action' => 'members']]); ?>
                                    ...
                                    <?php foreach ($families as $family): ?>
                                        <tr>
                                            ...
                                            <td style="text-align:left;">
                                                <?php 
                                                    if (
                                                        (isset($logged_roles['Residents']['action_view']))
                                                        && ($logged_roles['Residents']['action_view'] === 1)
                                                    ) {  ?>
                                                ...
                                                <?php 
                                                    if (
                                                        (isset($logged_roles['Residents']['action_edit']))
                                                        && ($logged_roles['Residents']['action_edit'] === 1)
                                                    ) {  ?>
                                                ...
                                                <?php 
                                                    if (
                                                        (isset($logged_roles['Residents']['action_delete']))
                                                        && ($logged_roles['Residents']['action_delete'] === 1)
                                                        && (false)
                                                    ) {  ?>
