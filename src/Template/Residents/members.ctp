            ...
            <div class="card">
                ...
                <div class="card-content">
                    <div style="padding:10px;">
                        Registered Residents Family Members
                    </div>
                                    ...
                                    <?php foreach ($families as $family): ?>
                                        <tr>
                                            ...
                                            <td style="text-align:left;">
                                                <?php 
                                                    if (
                                                        (isset($logged_roles['Residents']['action_index']))
                                                        && ($logged_roles['Residents']['action_index'] === 1)
                                                    ) {  ?>
                                                        <?= $this->Form->create('Add Search Item', ['type' => 'get', 'url' => ['controller' => 'Residents', 'action' => 'index', 1]]); ?>
